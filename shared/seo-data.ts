...
export const SERVICES: ServiceDef[] = [
  {
    ...
    description:
      "Aldridge & Charles Marine is a captain-owned firm based in South Florida. We serve as your shoreside office, running the day-to-day operations of your vessel with the perspective of someone who has actually managed yachts at sea. You receive a clear monthly report and direct communication on every matter that affects your boat.",
    highlights: [
      'Direct communication with the firm, by phone or email',
  ...
  },
  {
    ...
    description:
      "As a captain-owned firm we know the South Florida crew network personally. We focus on long-tenure placements: senior captain matches with our clients average just under three years, against an industry average closer to fourteen months.",
    highlights: [
      'Candidates known to us personally, not pulled from a database',
